...
async function createAdventurer(classId, title, strength, dexterity, intelligence, name) {
    const response = await fetch("api/adventurer", {
      method: "POST",
      body: JSON.stringify({classId, title, strength, dexterity, intelligence, name }),
